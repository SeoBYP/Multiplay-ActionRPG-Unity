...
| 영역 | 규칙 파일 |
|------|-----------|
| 서버 Clean Architecture + 도메인 경계 | [.Codex/rules/architecture-server.md](.Codex/rules/architecture-server.md) |
| SocketServer + 패킷 + Redis + 게임 흐름 | [.Codex/rules/networking.md](.Codex/rules/networking.md) |
| Unity 클라이언트 + gRPC + VContainer | [.Codex/rules/unity-client.md](.Codex/rules/unity-client.md) |
| 입력 시스템 분리 | [.Codex/rules/unity-input.md](.Codex/rules/unity-input.md) |
| 상태머신 + AttackState + 데미지 흐름 | [.Codex/rules/unity-gameplay-state.md](.Codex/rules/unity-gameplay-state.md) |
| 테스트 규칙 | [.Codex/rules/testing.md](.Codex/rules/testing.md) |
