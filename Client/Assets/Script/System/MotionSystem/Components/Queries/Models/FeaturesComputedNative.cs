...
{
 /// <summary>
 /// QueryComputed의 managed feature 데이터를 Burst job에서 읽기 좋게 평탄화한 NativeArray 묶음입니다.
 /// FeatureData는 frame별 배열 구조이고, 이 타입은 feature index * feature length 방식으로 접근할 수 있게 만듭니다.
 /// </summary>
 public struct FeaturesComputedNative
    {
        ...
        /// <summary>
        /// QueryComputed의 평균/표준편차/feature 배열을 NativeArray로 변환합니다.
        /// 이미 생성되어 있으면 기존 NativeArray를 재사용합니다.
        /// </summary>
