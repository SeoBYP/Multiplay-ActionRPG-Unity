...
namespace Game.System.MotionSystem
{
    public class LoopActionQueryComputedFlow : ActionQueryComputedFlow
    {
        ...
        public LoopActionQueryComputedFlow(
            ...
            float searchRate,
            float animationSwitchPenalty) : base(dataset, motionMatching.transform, currentBoneTransformsValues,
            characterTransformsNative, characterTransformBoneIndices, globalWeights,
            searchRate, animationSwitchPenalty)
        {
