...
namespace Game.Installers.Scenes.Startup
{
    ...
    public class OutGameSceneStartup : IAsyncStartable
    {
        ...
        public async UniTask StartAsync(CancellationToken ct)
        {
            ...
            Debug.Log($"[OutGameSceneStartup] UserProfile — PublicId={_userProfile.PublicId} NickName={_userProfile.NickName} HasProfile={_userProfile.HasProfile}");
            Debug.Log($"[OutGameSceneStartup] StartupIntentQueue — HasPending={_startupQueue.HasPending}");
        }
    }
}
