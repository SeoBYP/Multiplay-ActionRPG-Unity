...
{
    public class NPCAIInputComponent : MonoBehaviour
    {
        private ICharacterInputWriter _inputWriter;

        [SerializeField] private Transform[] m_waypoints;
        [SerializeField, Min(0.5f)] private float m_distanceThreshold = 1.0f;
        ...
        private void Update()
        {
            ...
            _inputWriter.SetMove(new Vector2(movementDirection.x, movementDirection.z));
        }
