...
namespace Game.Gameplay.Character
{
    public class FallState : State
    {
        ...
        public override void Enter()
        {
            ...
            _fallTimeoutRemaining = _settings.FallTimeout;
        ...
        protected override void StateUpdate(float deltaTime)
        {
            if (!_fallTriggered)
            {
                _fallTimeoutRemaining -= deltaTime;
                if (_fallTimeoutRemaining <= 0f)
                {
                    _animations.SetTrigger(AnimationTriggerType.Fall);
                    _fallTriggered = true;
                }
            }
        ...
        {
            _animations.ResetTrigger(AnimationTriggerType.Fall);
        }
    }
}
