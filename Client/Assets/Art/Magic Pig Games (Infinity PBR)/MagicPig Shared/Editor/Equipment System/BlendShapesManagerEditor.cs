...
namespace InfinityPBR
{
    ...
    [Serializable]
    public class BlendShapesManagerEditor : MagicPigEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            // Mark the component dirty only when something actually changed (a control edit or button click)
            // instead of on every repaint, which previously kept the inspector continuously re-dirtying/repainting.
